...
* PPO と鮫島らのモデルの対応付け
  ...
  * 鮫島らのモデルは詳細実装というより、参考モデルとして扱う
  * PPO の各処理を脳部位と一対一対応させるのではなく、Actor-Critic 型学習則として機能的に対応づける

* 学会用の対応図を作成する

  * PPO の目的関数そのものではなく、方策更新式を中心に図示する
  * 脳が PPO の $$\min$$ 演算や clip 処理をそのまま実装しているとは主張しない
